    ...
    <main>
      ...
      <div class="container">
        ...
        <div class="contact-form">
          ...
          <form @sumbit.prevent="submitForm" id="cform">
            ...
            <select v-model="formData.sluzba" id="sluzba" name="sluzba" required>
              ...
              <option value="service3">Televízia a Internet</option></select
            ><br /><br />
...
.con-link p {
  ...
  align-items: center; /* Center items vertically within each paragraph */
